...
RUN curl -Lk 'https://zyzmu-my.sharepoint.com/personal/pcw_zyzmu_onmicrosoft_com/_layouts/15/download.aspx?UniqueId=d49af491%2D51ac%2D444d%2D9189%2D5289331cc9de' --output /root/yolo.rar
RUN unrar x /root/yolo.rar
